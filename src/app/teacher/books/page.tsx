...
const Header: FC<{
  ...
  // AJUSTE 1: Stack na vertical em mobile (flex-col) e na horizontal em telas médias+ (md:flex-row)
  <div className="mb-8 flex flex-col items-start justify-between gap-4 border-b pb-4 md:flex-row md:items-center">
    <div>
      ...
      <p className="mt-1 text-muted-foreground">
        Explore os livros disponíveis para sua escola.
      </p>
    </div>
    {/* AJUSTE 2: Ocupa a largura total no mobile e tem uma largura máxima maior no desktop */}
