...
// --- API & Types ---
import { createTeacher, getSchools,  SchoolApiResponse,  type StudentCreationPayload } from "../services/api";
...
export default function StudentFormPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.success("Professor criado com sucesso!", { id: toastId });
  ...
  return (
    <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Criar Novo Professor</h1>
          <p className="text-muted-foreground">Preencha os detalhes abaixo para cadastrar um novo Professor.</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Os dados de acesso serão usados para o login do Professor na plataforma.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="name">Nome Completo do Professor</Label>
            ...
            <div className="space-y-4 border-t pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="email" name="email" type="email" value={formData.email} onChange={handleChange} placeholder="Professor@email.com" />
                </div>
                <div className="space-y-2">
                    ...
                    <div className="p-4 border rounded-md space-y-4 bg-background/50">
                      {selectedSchoolClasses.length > 0 ? (
                        ...
                        <p className="text-sm text-muted-foreground text-center py-2">
                          Nenhuma turma cadastrada. Crie a primeira abaixo!
                        </p>
                      )}
