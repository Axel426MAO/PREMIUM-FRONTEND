...
export default function EditTeacherPage() {
  ...
  const [formData, setFormData] = useState<UpdateStudentPayload | null>(null);
    ...
    const fetchInitialData = async () => {
      try {
        const [teacherData, schoolsData] = await Promise.all([
          getById(Number(teacherId)),
          getSchoolsBySecretaryId(user!.responsible?.secretary?.id ?? 0),
        ]);
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await update(Number(teacherId), payload);
        ...
        <form onSubmit={handleUpdate}>
          <fieldset disabled={isLoading} className="space-y-8">
            ...
            <FormSection
              ...
              description="Vincule o Aluno a uma escola e turma."
                ...
                <div className="grid gap-2">
                  ...
                  >
                    <PopoverTrigger asChild>
                      ...
                      >
                        {schools.find((s) => s.id === formData.school_id)
            ...
            {/* <FormSection
              ...
              description="Altere a senha de acesso do Aluno."
