    ...
    <main className="flex flex-1 flex-col gap-6 p-4 md:gap-8 md:p-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Suas informações pessoais, de contato e institucionais.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <ProfileDetail icon={User} label="Nome Completo" value={name} />
          ...
          {/* Seção de Vínculo Institucional */}
          <div>
            <h3 className="mb-4 text-lg font-medium text-foreground">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              {secretary ? (
                ...
                <ProfileDetail
                  icon={Info}
                  label="Vínculo"
                  value="Nenhum vínculo institucional direto."
                />
              )}
            </div>
          </div>
